const menuItems = [
    ...
    { name: "Biryani", price: 250, image: "../assests/images/menu-items/chickenbiryani.webp" },
    { name: "Momo", price: 130, image: "../assests/images/menu-items/momos.jpeg" },
    { name: "French Fries", price: 90, image: "../assests/images/menu-items/FF.jpg" },
    { name: "Coffee", price: 80, image: "../assests/images/menu-items/coffee.jpg" },
    { name: "Milkshake", price: 150, image: "../assests/images/menu-items/milkshake.jpg" },
    { name: "Drinks", price: 50, image: "../assests/images/menu-items/drink.png" }
];

const categories = {
    "All": menuItems,
    "Veg": menuItems.filter(item => ["Pizza", "Pasta", "Maggi", "French Fries"].includes(item.name)),
